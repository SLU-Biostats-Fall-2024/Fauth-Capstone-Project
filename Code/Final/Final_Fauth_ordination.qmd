...
ggplot()+
   geom_point(data = PlotData3, 
              ...
              color = "red",
              alpha = 0.5, position = position_jitter(width = 0.05,height = 0.05), size = 2) +
